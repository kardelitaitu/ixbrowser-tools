...
const SystemMetrics: React.FC<Props> = ({ metrics }) => {
  ...
  const MetricCard = ({ label, value, unit, percent, color }: any) => (
    ...
    <div className="mb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <MetricCard
          ...
          unit="GB"
          percent={Math.round((metrics.usedMemory / metrics.totalMemory) * 100)}
          color={getMetricColor(metrics.usedMemory, metrics.totalMemory)}
        />
        <MetricCard
          label="Memory Usage"
          value={memoryPercent}
